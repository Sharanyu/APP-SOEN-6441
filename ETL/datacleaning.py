...
class Transform:
    ...
    ,inplace=True, errors='raise')
        ...
        df[['work_location_borough', 'agency_name','title_description']] = df[['work_location_borough', 'agency_name','title_description']].astype(str).apply(lambda col: col.str.upper())
